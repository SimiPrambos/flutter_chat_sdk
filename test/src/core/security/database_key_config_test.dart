  ...
  group('DatabaseEncryptionConfig.isValid()', () {
    test('returns true for valid 256-bit hex key', () {
      final config = DatabaseEncryptionConfig(
        encryptionKey: '627ac90f35ac1a785afa41c586ea84e7e1c9205ec17264d2e2f77c00308a9318',
      );
    ...
    test('returns false for key with invalid characters', () {
      final config = DatabaseEncryptionConfig(
        encryptionKey: '627ac90f35ac1a785afa41c586ea84e7e1c9205ec17264d2e2f77c00308a931g', // 'g' is not valid hex
      );
    ...
    test('returns false for key that is too short', () {
      final config = DatabaseEncryptionConfig(
        encryptionKey: '627ac90f35ac1a785afa41c586ea84e7e1c9205ec17264d2e2f77c00308a931', // 63 characters
      );
      expect(config.isValid(), isFalse);
    });
    ...
    test('returns false for key that is too long', () {
      final config = DatabaseEncryptionConfig(
        encryptionKey: '627ac90f35ac1a785afa41c586ea84e7e1c9205ec17264d2e2f77c00308a9318a', // 65 characters
      );
      expect(config.isValid(), isFalse);
    });
    ...
    test('returns false for key with special characters', () {
      final config = DatabaseEncryptionConfig(
        encryptionKey: '627ac90f35ac1a785afa41c586ea84e7e1c9205ec17264d2e2f77c00308a931@',
      );
      expect(config.isValid(), isFalse);
    });
  });
